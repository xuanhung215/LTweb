      ...
      <section className="section">
        ...
        <div className="values-grid">
          {[
            ...
            { icon: <Lightbulb size={40} color="var(--primary)" />, title: "Kiến thức", desc: "Đội ngũ chuyên gia luôn cập nhật kiến thức mới nhất về đồ dùng công nghệ." },
            ...
            { icon: <Leaf size={40} color="var(--primary)" />, title: "Bền vững", desc: "Ưu tiên sản phẩm có chất lượng tốt, sử dụng lâu dài." },
          ].map((v) => (
