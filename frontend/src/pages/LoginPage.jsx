...
const LoginPage = ({ onLogin, navigate }) => {
  const [form, setForm] = useState({ email: "admin@protech.com", password: "Admin@123" });
    ...
    >
      ...
      <div className="auth-card" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div className="demo-hint">
          Demo: <strong style={{ color: "var(--primary)" }}>admin@protech.com</strong> / <strong style={{ color: "var(--primary)" }}>Admin@123</strong>
        </div>
