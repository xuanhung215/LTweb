      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div className="promo-banner" style={{ margin: "0 60px" }}>
          <div className="promo-text">
            <h2>SALE UP TO 20%</h2>
            <p>Ưu đãi khủng cho tất cả sản phẩm Điện thoại và Laptop. Chỉ áp dụng trong tháng này!</p>
          </div>
        ...
        <div className="features-grid">
          {[
            ...
            },
            {
              ...
              desc: "Tư vấn các thiết bị công nghệ phù hợp với mong muốn của bạn.",
            },
          ].map((f, i) => (
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div className="section-header">
          <div>
            ...
            <p className="section-subtitle">Hơn 20,000 khách hàng đã tin tưởng ProTech</p>
          </div>
        </div>
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div style={{
          ...
          <p style={{
            ...
            Khám phá hơn 500 sản phẩm chính hãng.
          </p>
